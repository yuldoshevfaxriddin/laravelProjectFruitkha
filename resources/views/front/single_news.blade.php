				...
				<div class="col-lg-4">
					<div class="sidebar-section">
						<div class="recent-posts">
							<h4>Recent Posts</h4>
							<ul>
								<li><a href="{{route('single-news-page')}}">You will vainly look for fruit on it in autumn.</a></li>
								<li><a href="{{route('single-news-page')}}">A man's worth has its season, like tomato.</a></li>
								<li><a href="{{route('single-news-page')}}">Good thoughts bear good fresh juicy fruit.</a></li>
								<li><a href="{{route('single-news-page')}}">Fall in love with the fresh orange</a></li>
								<li><a href="{{route('single-news-page')}}">Why the berries always look delecious</a></li>
							</ul>
						</div>
						<div class="archive-posts">
							<h4>Archive Posts</h4>
							<ul>
								<li><a href="{{route('single-news-page')}}">JAN 2019 (5)</a></li>
								<li><a href="{{route('single-news-page')}}">FEB 2019 (3)</a></li>
								<li><a href="{{route('single-news-page')}}">MAY 2019 (4)</a></li>
								<li><a href="{{route('single-news-page')}}">SEP 2019 (4)</a></li>
								<li><a href="{{route('single-news-page')}}">DEC 2019 (3)</a></li>
							</ul>
						</div>
						<div class="tag-section">
							<h4>Tags</h4>
							<ul>
								<li><a href="{{route('single-news-page')}}">Apple</a></li>
								<li><a href="{{route('single-news-page')}}">Strawberry</a></li>
								<li><a href="{{route('single-news-page')}}">BErry</a></li>
								<li><a href="{{route('single-news-page')}}">Orange</a></li>
								<li><a href="{{route('single-news-page')}}">Lemon</a></li>
								<li><a href="{{route('single-news-page')}}">Banana</a></li>
							</ul>
						</div>
					</div>
				</div>
